...
$("input[id='search']").click(function(){
    ...
    $.ajax({
        ...
        url:"http://localhost:8080/api/getHouseBySerach?"+string_search,
    ...
    $("input[id='delete_buildInfor']").click(function(){
        ...
        $.ajax({
            ...
            url:"http://localhost:8080/api/deleteBudding?"+stringIds,
    ...
    $(document).on('click','#edit', function () {
        ...
        $.ajax({
            ...
            url:"http://localhost:8080/api/getHouseById/"+id_get,
...
//在编辑界面，保存editTd编辑按钮
    ...
    $(document).on('click','#save_edit', function () {
        ...
        $.ajax({
            ...
            url:"http://localhost:8080/api/updateBudding",
    ...
    $(document).on('click','#add_buildInfor',function(){
        ...
        var text = "<form>"+
            ...
            "楼宇id："+ "<br>" + "<input type='text' value='"+"' id='id_add' disabled='disabled'>"+"</br>"+

            "<br>" +"楼宇名称："+ "<br>" +"<input type='text' value='"+"'id='buddingname_edit'>"+ "</br>"+

            "<br>" + "楼宇地址："+ "<br>" +"<input type='text' value='"+"'id='address_edit'>"+ "</br>"+

            "<br>" + "楼宇产权单位："+ "<br>" +"<input type='text' value='"+"'id='propertyunit_edit'>"+ "</br>"+

            "<br>" + "区域："+ "<br>" +"<input type='text' value='"+"'id='region_edit'>"+ "</br>"+
